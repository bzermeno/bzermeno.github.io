...
|---|---|---|
| Software Engineering & Design | CS-320: Software Testing, Automation, and QA | Java-based contact/task/appointment service with full JUnit test suite |
| Algorithms & Data Structures | CS-300: Data Structures and Algorithms | C++ course management system using hash tables and binary search trees |
